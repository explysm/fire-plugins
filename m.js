// Profanity Counter (No-Delay Version) Triggers in 
    ...
    .then(res => {
      if (res.isProfanity && res.score > 0.980) {
        ...
        utils.rpc_set({
            ...
            details: "Total swears: " + utils.storage.badWords,
            state: "Watching for profanity",
            assets: {
                large_image: "https://i.pinimg.com/originals/ac/ee/ae/aceeaea96ceeadcdae6958dfb93e2106.gif",
                large_text: "Swear Count: " + utils.storage.badWords
            }
        });

        // Optional: show a toast to let you know it worked
        utils.toast("Counter updated & RPC synced!");
      }
    });
  });
}
